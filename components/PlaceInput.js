...
export default class PlaceInput extends Component {
  ...
  async getPlaces() {
    ...
    try {
      const res = await fetch(`https://maps.googleapis.com/maps/api/place/autocomplete/json?key=${API_KEY}&input=${this.state.locationText}&location=${userLatitude},${userLongitude}&radius=2000`, {
        method: "get",
        headers: {
